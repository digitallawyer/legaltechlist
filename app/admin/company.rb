...
# https://github.com/activeadmin/activeadmin/blob/master/docs/2-resource-customization.md#setting-up-strong-parameters
  ...
  permit_params :name, :location, :founded_date, :category, :business_model, :target_client, :description, :main_url, :twitter_url, :angellist_url, :crunchbase_url, :all_tags, :category_id, :sub_category_id, :business_model_id, :target_client_id, :latitute, :longitude, :contact_name, :contact_email, :visible, :codex_presenter, :codex_presentation_date
